    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-[var(--color-bigchill)] selection:text-white">
      ...
      <section className="relative w-full lg:min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-0 lg:pb-20 px-4 md:px-8 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="hidden md:block absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 brightness-100 contrast-150 mix-blend-overlay"></div>        </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10 text-center lg:text-left">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
              <Link
                href="/pricing"
                className="w-full sm:w-auto px-8 py-4 mb-18 bg-slate-900 text-white font-bold rounded-xl hover:bg-slate-800 hover:shadow-lg transition-all flex items-center justify-center gap-2 group transform hover:-translate-y-1"
              >
                Get Started
              ...
              <button
                ...
                className="w-full sm:w-auto px-8 py-4 mb-18 bg-white text-slate-900 font-bold rounded-xl border-2 border-slate-100 hover:border-slate-200 hover:shadow-md transition-all flex items-center justify-center gap-2"
              >
                Book a Free Call
              </button>
            </div>
      ...
      {/* --- PRICING SECTION --- */}
      <section id="pricing" className="py-24 px-4 bg-white relative group overflow-hidden">
        ...
        <div className="md:hidden max-w-sm mx-auto text-center p-8 bg-slate-50 rounded-2xl border border-slate-200 shadow-sm">
          <p className="text-slate-600 font-medium leading-relaxed">
            Pricing will get reflected on screen once we start offering our services for big MNC's or foreign clients.
          </p>
        </div>
          ...
          <div className="absolute inset-0 z-50 bg-white/40 backdrop-blur-[2px] flex items-center justify-center p-6 cursor-default">
            <div className="max-w-2xl w-full bg-white/95 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-2xl border border-slate-200 transition-all duration-300">
              ...
              <div className="hidden group-hover:block text-slate-600 space-y-4 text-sm md:text-base leading-relaxed text-left md:text-center">
                <p>This is our Organization & Enterprise Pricing, built for large-scale businesses and agencies. We're currently not offering this, but it's something we're excited to launch in the future! 🚀</p>
                <p>Right now, our full focus is on building reliable, high-quality solutions that help people create, grow, and build a strong online presence. Every feature we build is designed with simplicity, performance, and long-term value in mind.</p>
                <p>We believe every big business once started small and we want to be there from day one of your journey.</p>
                <p className="font-semibold text-slate-900 pt-2 text-center">Thank you for your curiosity and support. It truly means a lot to us.</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {pricingPlans.map((plan, index) => (
                <motion.div
                  ...
                  transition={{ delay: index * 0.1 }}
                  viewport={{ once: true }}
                  className={`mobile-static p-8 rounded-3xl flex flex-col transition-all duration-300 ${hoveredPlan === index
