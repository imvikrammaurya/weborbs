                  ...
                  <LayoutGroup id="booking-modal-day-toggle">
                    {["Today", "Tomorrow"].map((day) => (
                      ...
                      >
                        ...
                        <span
                          className={`relative z-10 transition-colors duration-200 ${selectedDay === day
                            ? "text-white"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-2.5 bg-gray-50 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-300 ${phoneError
                      ...
                      <div className="grid grid-cols-2 gap-3 pt-1">
                        {timeSlots.map((time) => (
                          <button
                            ...
                            className={`py-2 text-sm border rounded-lg transition-all ${selectedTime === time
