...
const projects = [
  ...
  },
  {
    ...
    image:
      "https://ik.imagekit.io/vooklu/VOOKLU%20WEBSITE/WORK/bakery-sample-1_converted.avif?updatedAt=1771937767283", // Placeholder
    tech: ["React", "Tailwind", "Node.js"],
        ...
        >
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <p className="text-slate-400 text-lg mb-8">
              We'd love to help you bring your ideas to life. Let's discuss your
              next big thing.
            </p>
            <Link
              to="/contact"
